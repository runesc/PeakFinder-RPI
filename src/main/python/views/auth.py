...
class SignIn(QWidget):
	...
	def __init__(self, parent=None, *args):
		...
		parent.screen_size_signal.connect(self.retranslateUI)
		self.parent = parent
	...
	def retranslateUI(self):
		...
		self.jumbotron_bg.resize(percentage(65, sc['width']), sc['height'])
		self.jumbotron_span.resize(self.jumbotron_bg.width(), 170)
		self.jumbotron_span.move(0, sc['height']/2 - 86) # Screen heihgt/2 - jumbotron_span height/2





		self.footer.resize(percentage(35,  sc['width']), 400)
		self.footer.move(percentage(65, sc['width']), sc['height']-400) # Image fixed on bottom
